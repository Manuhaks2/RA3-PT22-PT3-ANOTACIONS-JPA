...
@Entity //Esta clase se guarda en la bd
@Table (name="person")
...
public class Person {
	...
	@OneToMany(mappedBy = "person", cascade = CascadeType.ALL, orphanRemoval = true) //oneToMany 1->muchos, mappedby: la fk esta en vehicle, cascade=all, guarda persona->guarda vehiculos
	private List<Vehicle> vehicles = new ArrayList<>();
	
	
	
	
	// Constructor vacío (Obligatorio para el JPA)
	public Person() 
	{
	}
